...
public class SendToSC_Stat extends ActionExecuterAbstractBase implements CustomActionExecuter {
	
public static final String NAME = "sc-stat-action";
	
	public static final String PARAM_SAVENODERULES_VALUE = "StatsaveNoderule";
    private CustomActionExecuter worker;
    
	public SendToSC_Stat(ClassManager classManager)
    {
		super();
    	CodeTransformer codeTrans = new CodeTransformer(classManager);
    	worker = (CustomActionExecuter) codeTrans.getObject("com.skytizens.alfresco.actions.SendToSC_StatEncoded", getClass());
    	if(worker == null){
	...
	public static Object generateImageToAlfresco(final Object object, final RetryingTransactionHelper retryingTransactionHelper, final ServiceRegistry serviceRegistry, final NodeService nodeService,
			final ContentService contentService, final NodeRef destination, final File sourceFile, final File path, final String fileName, final String currentUser){
